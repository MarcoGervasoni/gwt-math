...
public class BigInteger extends Number implements Cloneable,Serializable {
	 ...
	 * MIEI CAMPI
	 */
	public BigDecimal internalBigInteger = null;
	...
	public BigInteger[] divideAndRemainder(BigInteger val) {
		...
		final InternalBigDecimal subtract = internalBigInteger.internalBigDecimal.subtract(multiply.internalBigInteger.internalBigDecimal);
		subtract.setScale(0);
