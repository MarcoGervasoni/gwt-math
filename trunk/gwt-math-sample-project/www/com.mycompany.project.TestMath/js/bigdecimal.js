...
BigDecimal.prototype.ONE = new BigDecimal("1");
 ...
 function pow() {
  ...
  if (set.lostDigits) 
   this.checkdigits(rhs,set.digits);
  //GERVA
  //n=rhs.intcheck(n,this.MinArg,this.MaxArg); // check RHS by the rules
  n=this.intcheck(rhs,this.MinArg,this.MaxArg); // check RHS by the rules
